...
BackgroundTile = pygame.transform.scale(pygame.image.load(ROOT + "\\Images\\OBSIDIAN.png"), (settings.TileSize, settings.TileSize))

# Config

SliderOn = pygame.transform.scale(pygame.image.load(ROOT + "\\Images\\SliderOn.png"), (50, 50))
SliderOff = pygame.transform.scale(pygame.image.load(ROOT + "\\Images\\SliderOff.png"), (50, 50))
SliderX = 600
DSliderDown = pygame.transform.scale(pygame.image.load(ROOT + "\\Images\\DynamicSliderDown.png"), (50, 50))
DSliderUp = pygame.transform.scale(pygame.image.load(ROOT + "\\Images\\DynamicSliderUp.png"), (50, 50))
...
Bfont = pygame.font.Font(ROOT + "\\Fonts\\KidZone.ttf", 65)
